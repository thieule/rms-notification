...
use App\Api\V1\Models\UserActivity;
use App\Api\V1\Models\UserActivityInvolved;
use App\Api\V1\Models\UserNotificationCondition;
use App\Api\V1\Models\UserNotificationConfig;
use App\Api\V1\Models\UserNotificationMessage;
...
class Service
{
    ...
    {
        $mapping = [
                    'proposal' => 'App\Api\V1\Services\Proposal',
                    'resource_request' => 'App\Api\V1\Services\ResourceRequest',
                    'proposal_employee_status' => 'App\Api\V1\Services\Proposal',
                    'employee' => 'App\Api\V1\Services\Employee',
        ];
    ...
    {
        $mapping = [
            'proposal' => 'App\Api\V1\Services\Message',
            'resource_request' => 'App\Api\V1\Services\Message',
            'employee' => 'App\Api\V1\Services\Message',
        ];
